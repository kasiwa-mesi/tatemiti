<template>
  <div class="container">
    <h2 class="text-3xl py-4 text-center font-mono">利用規約</h2>
    <div class="description-wrap">
      <p>
        この利用規約（以下，「本規約」といいます。）は，かしわ(@kasiwa9494)（以下，「当サービス提供者」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
      </p>
      <h3 class="text-2xl py-4 text-left font-mono">第1条（適用）</h3>
      <p>
        本規約は，ユーザーと当サービス提供者との間の本サービスの利用に関わる一切の関係に適用されるものとします。
      </p>
      <h3 class="text-2xl py-4 text-left font-mono">第2条（利用登録）</h3>
      <p class="pb-4">
      ...
      <p class="pb-4">（1）本規約に違反したことがある者からの申請である場合</p>
      <p class="pb-4">
      ...
      <h3 class="text-2xl py-4 text-left font-mono">第3条（ユーザーIDおよびパスワードの管理）</h3>
      <p class="pb-4">
      ...
      <h3 class="text-2xl py-4 text-left font-mono">第4条（禁止事項）</h3>
      <p class="pb-4">
        ユーザーは，本サービスの利用にあたり，以下の行為をしてはなりません。
      </p>
      <p class="pb-4">（1）法令または公序良俗に違反する行為</p>
      <p class="pb-4">（2）犯罪行為に関連する行為</p>
      <p class="pb-4">
      ...
      <p class="pb-4">（6）他のユーザーに成りすます行為</p>
      <p class="pb-4">
      ...
      <p class="pb-4">（11）宗教活動または宗教団体への勧誘行為</p>
      <p class="pb-4">（12）その他，当サービス提供者が不適切と判断する行為</p>
      <h3 class="text-2xl py-4 text-left font-mono">
        第5条（本サービスの提供の停止等）
      </h3>
      <p class="pb-4">
      ...
      <p class="pb-4">（1）本規約のいずれかの条項に違反した場合</p>
      <p class="pb-4">（2）登録事項に虚偽の事実があることが判明した場合</p>
      <p class="pb-4">
        （3）破産，民事再生，会社更生または特別清算の手続開始決定等の申立がなされたとき
      </p>
      <p class="pb-4">（4）1年間以上本サービスの利用がない場合</p>
      <p class="pb-4">
        （5）当サービス提供者からの問い合わせその他の回答を求める連絡に対して30日間以上応答がない場合
      </p>
      <p class="pb-4">（6）第2条第2項各号に該当する場合</p>
      <p class="pb-4">
      ...
      <h3 class="text-2xl py-4 text-left font-mono">第9条（利用規約の変更）</h3>
      <p class="pb-4">
